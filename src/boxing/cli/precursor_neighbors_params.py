...
def get_params(config_path: Path | None, dataset_path: Path, overrides: dict | None = None) -> dict[str, float | int | str]:
    cfg = validate_config(config_path, require_cpp_backend_compat=True, overrides=overrides)
